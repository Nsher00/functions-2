...
// CODE HERE
const oneLine = (p1,p2)=> console.log(`The first parameter is ${p1} the second parameter is ${p2}.`);
...
const greeting = (firstName,lastName,callback)=> (firstName + " " + lastName)
const greetingLog = (fullName) => console.log(`Hello, my full name is ${fullName}`);
// INVOKE 'GREETING FUNCTION' HERE
greetingLog(greeting('Noah','Sherwood'))
...
const addTax = (arr) =>console.log(`The new array plus tax = ${arr}`);
